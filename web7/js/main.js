$(function () {
    ...
    $(window).scroll(function () {
        ...
        if (ht != logo) {
            ...
            $(".text_wrap1").addClass("on",1000);
        } else if(ht == logo) {
            $(".con_bg").css({backgroundColor: "rgba(0,0,0,0.3)"});
            $(".main_swipe").css({opacity:"1"});
            $(".text_wrap1").removeClass("on",700);
        }
        
        var jenni = $(".main_txt").offset().top;
        console.log("jenni:" + jenni);
        if (ht >= jenni - 1000) {
            $(".main_txt").addClass("on",700);
            $(".muse_con .sub_fr").addClass("on",1500);
            $(".muse_con .visual_wrap img").css({transform:"scale(1)"});
        } else if(ht <= jenni - 1000) {
            $(".muse_con .sub_fr").removeClass("on",100);
            $(".main_txt").removeClass("on",500);
        ...
        if(ht >= black - 1200) {
            $(".hera_con .main_txt1").addClass("on",500);
            $(".hera_con .sub_fr").addClass("on",1500);
            $(".hera_con .visual_wrap img").css({transform:"scale(1)"});
        } else if(ht <= black - 1200) {
            $(".hera_con .sub_fr").removeClass("on",500);
            $(".hera_con .main_txt1").removeClass("on",700);
        ...
        if(ht >= here - 1000) {
            $(".here_wrap .main_title").addClass("on",700);
            $(".here_wrap .text_sub").addClass("on",1500);
        } else if(ht <= here - 1000) {
            $(".here_wrap .main_title").removeClass("on",500);
            $(".here_wrap .text_sub").removeClass("on",500);
        }
        ...
        if(ht >= best - 1200) {
            $(".best_fr .text_title1").addClass("on",700);
            $(".best_fr .grid1").animate({top:"-100px"}, 1500);
            $(".best_fr .text_sub").addClass("on",1500);
        } else if(ht <= best - 1200) {
            $(".best_fr .text_title1").removeClass("on",500);
            $(".best_fr .text_sub").removeClass("on",500);
        }
        ...
        if(ht >= allPro - 1000) {
            $(".all_wrap .text_title1").addClass("on",700);
            $(".all_wrap .text_sub").addClass("on",1500);
        } else if(ht <= allPro - 1000) {
            $(".all_wrap .text_title1").removeClass("on",500);
            $(".all_wrap .text_sub").removeClass("on",500);
        }
