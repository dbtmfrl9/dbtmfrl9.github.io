$(function(){
    ...
    function next_ani() {
        $(".vs .img_box").not(":animated").animate({"margin-left":"-1920px"}, 500, function(){
            $(".vs .img_box li").eq(0).appendTo($(".vs .img_box"));
            $(".vs .img_box").css({"margin-left":"0px"});
        });
    }
    function prev_ani() {
        $(".vs .img_box li").eq(len-1).prependTo($(".vs .img_box"));
        $(".vs .img_box").css("margin-left", -wd+"px");
        $(".vs .img_box").not(":animated").animate({"margin-left":"0px"}, 500);
    }
